...
class ParentAddKidAndParent : AppCompatActivity() {
    ...
    //set creatorID to global variable
    ...
    private val navigation = BottomNavigationView.OnNavigationItemSelectedListener { item ->
        when (item.itemId) {
            R.id.ic_home -> {
                val intent = Intent(this@ParentAddKidAndParent, InvitedParentActivity::class.java)
            ...
            R.id.ic_person -> {
                val intent = Intent(this@ParentAddKidAndParent,  ParentsActivity::class.java)
                startActivity(intent)
                overridePendingTransition(0, 0)
                finish()
                overridePendingTransition(0, 0)
            ...
            R.id.ic_help -> {
                val intent = Intent(this@ParentAddKidAndParent, Logout_sample::class.java)
                startActivity(intent)
                overridePendingTransition(0, 0)
                finish()
                overridePendingTransition(0, 0)
            ...
            R.id.ic_setting -> {
                val intent = Intent(this@ParentAddKidAndParent, SettingMainActivity::class.java)
                startActivity(intent)
                overridePendingTransition(0, 0)
                finish()
                overridePendingTransition(0, 0)
            ...
            R.id.ic_notify -> {
                val intent = Intent(this@ParentAddKidAndParent, NotifyActivity::class.java)
                startActivity(intent)
                overridePendingTransition(0, 0)
                finish()
                overridePendingTransition(0, 0)
...
//            }
    ...
    private fun AddParent() {
        if(users.contains(familyNameInput.text.toString())){
            ...
            val currentUserDb =
                databaseRefParent?.child(current) // current time as a ID
            val parent = Parent(
                familyNameInput.text.toString(),
                "2",
                "Parent",
                sessionManager!!.creatorID.toString(),
